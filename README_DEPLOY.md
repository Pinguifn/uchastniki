...
Сайт показывает информационное уведомление о необходимых технологиях браузера. В текущей версии аналитические и рекламные cookie не используются. Факт ознакомления хранится только в `localStorage` под ключом `uch_cookie_notice_v1` до 180 дней.
